...
public class TwoPlayersPlayTheGame
{
    ...
    public async Task Scenario()
    {
        var results = await new TestBuilder()
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(1), description: "Knuth has one card")
            .GetCards(WhichPlayer.Graham, new DealNumber(1), description: "Graham has one card")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(2), description: "Knuth has two cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(2), description: "Graham has one card")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(3), description: "Knuth has three cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(3), description: "Graham has one card")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(4), description: "Knuth has four cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(4), description: "Graham has one card")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(5), description: "Knuth has five cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(5), description: "Graham has one card")
