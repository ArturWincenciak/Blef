...
public class TreePlayersPlayTheGame
{
    ...
    public async Task Scenario()
    {
        var results = await new TestBuilder()
            ...
            .GetCards(WhichPlayer.Conway, new DealNumber(2), description: "Conway has two cards")
            ...
            .GetCards(WhichPlayer.Conway, new DealNumber(3), description: "Conway has two cards")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(4), description: "Knuth has two cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(4), description: "Graham has two cards")
            .GetCards(WhichPlayer.Conway, new DealNumber(4), description: "Conway has two cards")
            ...
            .GetCards(WhichPlayer.Conway, new DealNumber(5), description: "Conway has three cards")
            ...
            .GetCards(WhichPlayer.Graham, new DealNumber(6), description: "Graham has three cards")
            .GetCards(WhichPlayer.Conway, new DealNumber(6), description: "Conway has three cards")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(7), description: "Knuth has two cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(7), description: "Graham has four cards")
            .GetCards(WhichPlayer.Conway, new DealNumber(7), description: "Conway has three cards")
            ...
            .GetCards(WhichPlayer.Graham, new DealNumber(8), description: "Graham has four cards")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(8), description: "Knuth has three cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(8), description: "Graham has four cards")
            .GetCards(WhichPlayer.Conway, new DealNumber(8), description: "Conway has four cards")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(10), description: "Knuth has four cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(10), description: "Graham has four cards")
            .GetCards(WhichPlayer.Conway, new DealNumber(10), description: "Conway has four cards")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(11), description: "Knuth has five cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(11), description: "Graham has four cards")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(12), description: "Knuth has five cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(12), description: "Graham has five cards")
            .GetCards(WhichPlayer.Conway, new DealNumber(12), description: "Conway has four cards")
            ...
            .GetCards(WhichPlayer.Knuth, new DealNumber(13), description: "Knuth has five cards")
            .GetCards(WhichPlayer.Graham, new DealNumber(13), description: "Graham lost the game")
            .GetCards(WhichPlayer.Conway, new DealNumber(13), description: "Conway has four cards")
            .BidFourOfAKind(WhichPlayer.Conway, FaceCard.King, description: "Conway starts the deal")
            .Check(WhichPlayer.Knuth, description: "Knuth checks, Conway get lost the deal")
            .GetGameFlow()
            .GetDealFlow(deal: new DealNumber(13))

            .GetCards(WhichPlayer.Knuth, new DealNumber(14), description: "Knuth has five cards")
            .GetCards(WhichPlayer.Conway, new DealNumber(14), description: "Conway has five cards")
