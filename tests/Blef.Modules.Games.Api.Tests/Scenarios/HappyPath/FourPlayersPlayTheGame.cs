...
public class FourPlayersPlayTheGame
{
    ...
    public async Task Scenario()
    {
        var results = await new TestBuilder()
            ...
            .GetCards(WhichPlayer.Riemann, deal: new(1), description: "Riemann has one card")
            ...
            .GetCards(WhichPlayer.Conway, deal: new(2), description: "Conway has one card")
            .GetCards(WhichPlayer.Riemann, deal: new(2), description: "Riemann has two card")
            ...
            .GetCards(WhichPlayer.Conway, deal: new(3), description: "Conway has one card")
            .GetCards(WhichPlayer.Riemann, deal: new(3), description: "Riemann has two cards")
            ...
            .GetCards(WhichPlayer.Knuth, deal: new(4), description: "Knuth has one card")
            .GetCards(WhichPlayer.Graham, deal: new(4), description: "Graham has two cards")
            .GetCards(WhichPlayer.Conway, deal: new(4), description: "Conway has one card")
            .GetCards(WhichPlayer.Riemann, deal: new(4), description: "Riemann has three cards")
            ...
            .GetCards(WhichPlayer.Conway, deal: new(5), description: "Conway has one card")
            .GetCards(WhichPlayer.Riemann, deal: new(5), description: "Riemann has three cards")
            ...
            .GetCards(WhichPlayer.Graham, deal: new(6), description: "Graham has two cards")
            .GetCards(WhichPlayer.Conway, deal: new(6), description: "Conway has two cards")
            .GetCards(WhichPlayer.Riemann, deal: new(6), description: "Riemann has three cards")
            ...
            .GetCards(WhichPlayer.Knuth, deal: new(7), description: "Knuth has three cards")
            .GetCards(WhichPlayer.Graham, deal: new(7), description: "Graham has two cards")
            .GetCards(WhichPlayer.Conway, deal: new(7), description: "Conway has two cards")
            .GetCards(WhichPlayer.Riemann, deal: new(7), description: "Riemann has three cards")
            ...
            .GetCards(WhichPlayer.Graham, deal: new(8), description: "Graham has two cards")
            .GetCards(WhichPlayer.Conway, deal: new(8), description: "Conway has three cards")
            .GetCards(WhichPlayer.Riemann, deal: new(8), description: "Riemann has three cards")
            ...
            .GetCards(WhichPlayer.Knuth, deal: new(9), description: "Knuth has three cards")
            .GetCards(WhichPlayer.Graham, deal: new(9), description: "Graham has two cards")
            .GetCards(WhichPlayer.Conway, deal: new(9), description: "Conway has three cards")
            .GetCards(WhichPlayer.Riemann, deal: new(9), description: "Riemann has four cards")
            ...
            .GetGameFlow()
            .GetDealFlow(new(9))
            .GetCards(WhichPlayer.Knuth, deal: new(10), description: "Knuth has three cards")
            .GetCards(WhichPlayer.Graham, deal: new(10), description: "Graham has three cards")
            .GetCards(WhichPlayer.Conway, deal: new(10), description: "Conway has three cards")
            .GetCards(WhichPlayer.Riemann, deal: new(10), description: "Riemann has four cards")
            ...
            .GetGameFlow()
            .GetDealFlow(new(10))
            .GetCards(WhichPlayer.Knuth, deal: new(11), description: "Knuth has three cards")
            .GetCards(WhichPlayer.Graham, deal: new(11), description: "Graham has three cards")
            .GetCards(WhichPlayer.Conway, deal: new(11), description: "Conway has three cards")
            .GetCards(WhichPlayer.Riemann, deal: new(11), description: "Riemann has five cards")
            .BidFlush(WhichPlayer.Knuth, Suit.Clubs, description: "Conway starts the deal")
            .Check(WhichPlayer.Graham, description: "Graham checks the bid and get lost the deal")
            .GetGameFlow()
            .GetDealFlow(new(11))
            .GetCards(WhichPlayer.Knuth, deal: new(12), description: "Knuth has three cards")
            .GetCards(WhichPlayer.Graham, deal: new(12), description: "Graham has four cards")
            .GetCards(WhichPlayer.Conway, deal: new(12), description: "Conway has three cards")
            .GetCards(WhichPlayer.Riemann, deal: new(12), description: "Riemann has five cards")
            ...
            .GetGameFlow()
            .GetDealFlow(new(12))
            .GetCards(WhichPlayer.Knuth, deal: new(13), description: "Knuth has three cards")
            .GetCards(WhichPlayer.Graham, deal: new(13), description: "Graham has four cards")
            .GetCards(WhichPlayer.Conway, deal: new(13), description: "Conway has three cards")
            .GetCards(WhichPlayer.Riemann, deal: new(13), description: "Riemann lost the game")
            .BidHighCard(WhichPlayer.Knuth, FaceCard.Ace, description: "Knuth starts the deal")
            .Check(WhichPlayer.Graham, description: "Graham checks the bid and lost the deal")
            .GetGameFlow()
            .GetDealFlow(new(13))
            .GetCards(WhichPlayer.Knuth, deal: new(14), description: "Knuth has three cards")
            .GetCards(WhichPlayer.Graham, deal: new(14), description: "Graham has five cards")
            .GetCards(WhichPlayer.Conway, deal: new(14), description: "Conway has three cards")
            .BidPair(WhichPlayer.Conway, FaceCard.Ace, description: "Conway starts the deal")
            .BidFourOfAKind(WhichPlayer.Knuth, FaceCard.Ace)
            .Check(WhichPlayer.Graham, description: "Graham checks the bid, Knuth get lost the deal")
            .GetGameFlow()
            .GetDealFlow(new(14))
            .GetCards(WhichPlayer.Knuth, deal: new(15), description: "Knuth has four cards")
            .GetCards(WhichPlayer.Graham, deal: new(15), description: "Graham has five cards")
            .GetCards(WhichPlayer.Conway, deal: new(15), description: "Conway has three cards")
            .BidHighCard(WhichPlayer.Graham, FaceCard.Ace, description: "Graham starts the deal")
            .Check(WhichPlayer.Conway, description: "Conway checks the bid and lost the deal")
            .GetGameFlow()
            .GetDealFlow(new(15))
            .GetCards(WhichPlayer.Knuth, deal: new(16), description: "Knuth has four cards")
            .GetCards(WhichPlayer.Graham, deal: new(16), description: "Graham has five cards")
            .GetCards(WhichPlayer.Conway, deal: new(16), description: "Conway has four cards")
            .BidHighCard(WhichPlayer.Knuth, FaceCard.Ace, description: "Knuth starts the deal")
            .Check(WhichPlayer.Graham, description: "Graham checks the bid and get lost the GAME!")
            .GetGameFlow()
            .GetDealFlow(new(16))
            .GetCards(WhichPlayer.Knuth, deal: new(17), description: "Knuth has four cards")
            .GetCards(WhichPlayer.Graham, deal: new(17), description: "Graham lost the game")
            .GetCards(WhichPlayer.Conway, deal: new(17), description: "Conway has four cards")
            .BidHighCard(WhichPlayer.Conway, FaceCard.Ace, description: "Conway starts the deal")
            .Check(WhichPlayer.Knuth, description: "Knuth checks the bid and get lost the deal")
            .GetGameFlow()
            .GetDealFlow(new(17))
            .GetCards(WhichPlayer.Knuth, deal: new(18), description: "Knuth has five cards")
            .GetCards(WhichPlayer.Conway, deal: new(18), description: "Conway has four cards")
            .BidHighCard(WhichPlayer.Conway, FaceCard.Ace, description: "Conway starts the deal")
